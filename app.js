...
function categoryScore(course, category, entries) {
  ...
  const kept = scores; // drops disabled until there are enough graded entries per category
...
function courseGrade(courseId) {
  ...
  const activeCategories = course.categories.filter(category => categoryScore(course, category, graded) !== null);
